...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO usuarios (nombre_usuario, nombre_completo, sexo, fecha_nacimiento, avatar, correo, contraseña, rol) 
            VALUES (:username, :full_name, :gender, :birthdate, :photo, :email, :password, :role)";
