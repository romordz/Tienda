...
$sql = "SELECT nombre_usuario, nombre_completo, sexo, fecha_nacimiento, avatar, correo, rol, privacidad FROM usuarios WHERE id = ?";
...
if ($profile_data) {
    ...
    $profile_avatar = base64_encode($profile_data['avatar']);
